#!/bin/bash
#
# OpenClaw Installation Script for macOS 13 Ventura
...
echo -e "${BLUE}================================${NC}"
echo -e "${BLUE}OpenClaw Installer for macOS 13 Ventura${NC}"
echo -e "${BLUE}================================${NC}"
echo ""
...
# Create configuration with Ventura-specific settings
...
echo ""
echo -e "Ventura-specific features:"
echo -e "  - Optimized for Stage Manager"
echo -e "  - Passkey support ready"
echo -e "  - Metal 3 graphics support"
echo ""
