#!/bin/bash
#
# OpenClaw Installation Script for macOS 15 Sequoia
...
echo -e "${BLUE}================================${NC}"
echo -e "${BLUE}OpenClaw Installer for macOS 15 Sequoia${NC}"
echo -e "${BLUE}================================${NC}"
echo ""
...
echo ""
echo -e "Sequoia-specific features:"
echo -e "  - Apple Intelligence ready"
echo -e "  - Enhanced security features"
echo -e "  - Latest Metal 3 support"
echo ""
